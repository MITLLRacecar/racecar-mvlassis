...
def update_contour():
    ...
    if image is None:
        ...
        ### Δείτε τις global μεταβλητές που έχουμε ορίσει πάνω
        for color in color_priorities:
            # Find all the contours corresponding to the current color
            ### ??? Θέλουμε τα contours που αντιστοιχούν στο συγκεκριμένο color κάθε φορά
        ...
        if contour is not None:
            ...
            ### Προσθήκη: Χρειαζόμαστε το moment για proportional control
    ...
    if contour_center is not None:
        ...
        if contour is not None:
            ...
            if w > 3 * rc.camera.get_width() / 4:
                ...
                angle = rc_utils.remap_range(contour_center[1], rc.camera.get_width()/2, rc.camera.get_width(), 0, 1)
        ### Τέλος
