...
def drive_hallway():
    ...
    queue.append([0.8, 0.5, 0.5])
    queue.append([2.5, 0.5, 0])
    queue.append([1.4, 0.5, -0.5])
    queue.append([1.8, 0.5, 0])
    queue.append([2.4, 0.4, 0.6])
    queue.append([3.2, 0.4, -0.7])
    queue.append([3.4, 0.4, 0.7])
    queue.append([2, 0.4, -0.7])
...
def drive_maze():
    ...
    queue.clear()
    queue.append([5.5, 1, 0])
    queue.append([1.4, 0.5, -1])
    queue.append([2.8, 1, 0])
    queue.append([6.4, 0.3, -1])
    queue.append([1.6, 1, 0])
    queue.append([7.4, 0.3, 1])
    queue.append([0.3, 1, 0])
    queue.append([3.5, 0.4, -1])
    queue.append([0.1, 1, 0])
    queue.append([10, 0.3, 1])
    queue.append([1, 1, 0])
    queue.append([9, 0.25, -1])
    queue.append([5, 1, 0])
